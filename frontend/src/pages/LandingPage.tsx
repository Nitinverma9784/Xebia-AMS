    ...
    <div className="min-h-screen bg-[var(--brand-surface)] flex flex-col">
      ...
      <nav className="flex items-center justify-between px-6 py-4 border-b border-[var(--brand-border)]">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[#4A1F4F] to-[#622865] flex items-center justify-center">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center py-16">
        <div className="relative">
          <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-[#4A1F4F]/10 to-[#2563EB]/10 blur-2xl" />
          <div className="relative w-20 h-20 rounded-3xl bg-gradient-to-br from-[#4A1F4F] to-[#622865] flex items-center justify-center mx-auto mb-6 shadow-xl">
            <GraduationCap size={36} className="text-white" />
          </div>
        </div>

        <h1 className="text-4xl md:text-5xl font-extrabold text-[var(--text-primary)] mb-4">
          Xebia <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4A1F4F] to-[#2563EB]">LMS</span>
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md">
          <Link
            to="/teacher/login"
            className="group flex flex-col items-center gap-3 p-6 bg-white dark:bg-[#1E293B] border border-[var(--brand-border)] rounded-2xl hover:border-[#4A1F4F] hover:shadow-lg transition-all duration-200"
          >
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#4A1F4F] to-[#622865] flex items-center justify-center shadow-sm">
              <GraduationCap size={22} className="text-white" />
            </div>
            <div>
              <p className="font-semibold text-[var(--text-primary)] group-hover:text-[#4A1F4F] transition-colors">Teacher Portal</p>
