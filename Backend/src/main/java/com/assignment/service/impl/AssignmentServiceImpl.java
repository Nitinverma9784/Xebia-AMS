...
public class AssignmentServiceImpl implements AssignmentService {
    ...
    public List<AssignmentResponse> assignBatch(Long assignmentId, List<Long> batchIds, String teacherEmail) {
        ...
        // If the assignment is currently a draft (has no batch) and has no submissions, use it for the first batch
        if (assignment.getBatch() == null && submissionRepository.countByAssignmentId(assignmentId) == 0) {
